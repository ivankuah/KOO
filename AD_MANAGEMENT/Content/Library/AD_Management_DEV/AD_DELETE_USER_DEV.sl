...
flow:
  ...
  workflow:
        ...
        do_external:
          6f9d9ce8-c6c2-40ea-a5f9-66bdef9c27ad:
            ...
            - password:
                value: '${AD_AdminPass}'
                sensitive: true
            - filter: "${'(&(objectClass=person)(distinguishedName=CN=' + UserFullName + ','+ OU +',DC=kenanga,DC=local))'}"
            - propertyName: cn
        ...
        do_external:
          6f9d9ce8-c6c2-40ea-a5f9-66bdef9c27ad:
            ...
            - password:
                value: '${AD_AdminPass}'
                sensitive: true
            - filter: "${'(&(objectClass=person)(cn=r_' + UserFullName + '))'}"
        ...
        do_external:
          f0b2afd2-5733-47e4-80ba-7f2387cc66d5:
            ...
            - password:
                ...
                sensitive: true
            - port: '5985'
            - script: "${'try { Set-ADUser -Identity \"'+ getLoginName +'\" -DisplayName \"r_'+ getUserFullName +'\" -ErrorAction Stop; Write-Host \"Update successful\" } catch { Write-Host \"Update failed: $($_.Exception.Message)\" }'}"
        publish:
          - deleteUserResult: '${returnResult}'
        navigate:
    ...
    - Search_and_Replace:
        ...
        navigate:
          - success: Disable_User_After_Replaced
          - failure: FAILURE
        ...
        do_external:
          f0b2afd2-5733-47e4-80ba-7f2387cc66d5:
            ...
            - password:
                ...
                sensitive: true
            - port: '5985'
            - script: "${'try { Rename-ADObject -Identity \"CN='+ getUserFullName +','+OU+',DC=kenanga,DC=local\" -NewName \"r_'+ getUserFullName +'\" -ErrorAction Stop; Write-Host \"Update successful\" } catch { Write-Host \"Update failed: $($_.Exception.Message)\" }'}"
        publish:
          - deleteUserResult: '${returnResult}'
        navigate:
          - success: Move_User
        ...
        do_external:
          f0b2afd2-5733-47e4-80ba-7f2387cc66d5:
            ...
            - password:
                ...
                sensitive: true
            - port: '5985'
            - script: "${'try { Set-ADUser -Identity \"'+ getLoginName +'\" -DisplayName \"r_'+ UserFullName +'\" -ErrorAction Stop; Write-Host \"Update successful\" } catch { Write-Host \"Update failed: $($_.Exception.Message)\" }'}"
        publish:
          - deleteUserResult: '${returnResult}'
        navigate:
    ...
    - GetLoginName:
        ...
        publish:
          - deleteUserResult: '${returnResult}'
          - getLoginName: '${returnResult}'
        navigate:
          - failure: FAILURE
          - success: String_Comparator
    - Disable_User_After_Replaced:
        do_external:
    ...
    - Disable_User:
        ...
        publish:
          - disableUserResult: '${returnResult}'
        navigate:
          - success: Rename_User_Display_Name
          - failure: FAILURE
  outputs:
  ...
  graph:
    steps:
      ...
      Disable_User:
        ...
        'y': 160
        navigate:
          1d808741-09a5-746f-bcbd-a96ea4dc9691:
            targetId: 48ea08fe-77dc-b9d4-b74c-9c2dfec02c46
            port: failure
      String_Comparator:
        x: 560
      ...
      Sleep:
        ...
        'y': 720
        navigate:
          8c083517-18ea-7bfa-879b-da3eaada7714:
            targetId: 48ea08fe-77dc-b9d4-b74c-9c2dfec02c46
            port: failure
      Rename_User_Display_Name_After_Replaced:
        x: 360
      ...
      GetLoginName:
        ...
        'y': 40
        navigate:
          a094b217-7f43-7505-2dc2-172b0c22f847:
            targetId: 48ea08fe-77dc-b9d4-b74c-9c2dfec02c46
            port: failure
    results:
      SUCCESS:
